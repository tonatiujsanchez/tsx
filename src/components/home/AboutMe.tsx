            ...
            <div className="container px-5 flex flex-col md:flex-row md:items-center gap-10">
                ...
                <div className="md:w-[60%]">
                    ...
                    <p className="mb-5">Soy Desarrollador Web Frontend con un fuerte compromiso
                        ...
                        usabilidad y rendimiento.He tenido la oportunidad de utilizar
                        varios programas de diseño y lenguajes de programación para
                        satisfacer con éxito las necesidades de diferentes tipos de
                        clientes.</p>
                    <p className="mb-5">Además de mi experiencia en el desarrollo web, también disfruto explorar nuevas tecnologías y aprender constantemente. Actualmente me encuantro aprendiendo el idioma ingles con el fin de expander mis oportunidades.</p>
