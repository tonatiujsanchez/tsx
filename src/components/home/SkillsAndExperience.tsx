...
export const SkillsAndExperience = () => {
    return (
        <section id="experience" className="bg-white">
            <SectionExperience className="py-10 sm:py-20 relative bg-white">
                <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-28 justify-evenly">
                    <div className="lg:sticky lg:top-24 lg:h-[47rem] order-2 lg:order-1">
                    ...
                    <div className="px-5 mx-auto sm:mx-10 lg:mx-0 order-1 lg:order-2">
...
const SectionExperience = styled.div`
    ...
    background: radial-gradient(45.48% 30.48% at 90.38% 50.52%, #d5e9f1 0%, rgba(255, 255, 255, 0) 100%);
